...
In evaluation, a confidence interval gives an estimated range for a [metric](/en/glossary/distance-metric/)—such as accuracy or [hallucination rate](/en/glossary/hallucination-rate/)—reflecting sampling variability in the test set.
