...
A: Start with IndexFlatL2/IP for <100K vectors (exact, simple). For 100K-10M, use IndexIVFFlat or IndexHNSWFlat. For 10M-1B, use IndexIVFPQ. For >1B, consider distributed solutions or aggressive compression. Always benchmark on your actual data and query patterns—generic advice only goes so far.
